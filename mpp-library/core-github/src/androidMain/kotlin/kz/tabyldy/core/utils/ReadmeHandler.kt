...
object ReadmeHandler {
    ...
    suspend fun handle(url: String, context: Context): String {
        return withContext(Dispatchers.IO) {
           ...
           // val typedValue = TypedValue()
            ...
            val background = "#0D1117"/*"#" + Integer.toHexString(typedValue.data).substring(2)*/
           /* theme.resolveAttribute(
                com.google.android.material.R.attr.colorOnPrimary, typedValue, true
            )*/
            val primaryColor = "#FFFFFFFF"/*"#" + Integer.toHexString(typedValue.data).substring(2)*/
            /*theme.resolveAttribute(
                com.google.android.material.R.attr.colorPrimary, typedValue, true
            )*/
            val linkColor = "#58A6FF"/*"#" + Integer.toHexString(typedValue.data).substring(2)*/
