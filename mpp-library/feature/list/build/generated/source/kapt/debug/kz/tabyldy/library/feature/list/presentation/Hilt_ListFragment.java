...
public abstract class Hilt_ListFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListFragment_GeneratedInjector) this.generatedComponent()).injectListFragment(UnsafeCasts.<ListFragment>unsafeCast(this));
    }
  }
